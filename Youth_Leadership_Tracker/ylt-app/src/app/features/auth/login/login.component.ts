    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div class="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
        ...
        <div class="text-center mb-8">
          ...
          <h1 class="text-3xl font-bold text-gray-800">Youth Leadership Tracker</h1>
          <p class="text-gray-600 mt-2">AIESEC Local Committee Management</p>
        </div>

        <!-- Alert Messages -->
        <div *ngIf="errorMessage" class="mb-4 p-4 bg-red-50 border-l-4 border-red-500 rounded">
          <p class="text-red-700 font-medium">{{ errorMessage }}</p>
        </div>

        <div *ngIf="successMessage" class="mb-4 p-4 bg-green-50 border-l-4 border-green-500 rounded">
        ...
        <form #loginForm="ngForm" (ngSubmit)="onLogin(loginForm)" [ngClass]="{'opacity-50 pointer-events-none': isAccountLocked}">
          ...
          <div class="mb-5">
            ...
            />
            <p *ngIf="emailInput.invalid && emailInput.touched" class="text-red-500 text-sm mt-1">
          ...
          <div class="mb-6">
            ...
            <input
              ...
              [disabled]="isAccountLocked"
            />
            <p *ngIf="passwordInput.invalid && passwordInput.touched" class="text-red-500 text-sm mt-1">
              Password must be at least 6 characters
            </p>
          </div>

          <!-- Attempt Counter -->
          <div *ngIf="!isAccountLocked && loginAttempts > 0" class="mb-4 p-3 bg-yellow-50 border-l-4 border-yellow-500 rounded">
          ...
          <!-- Lockout Timer -->
          <div *ngIf="isAccountLocked" class="mb-4 p-3 bg-red-50 border-l-4 border-red-500 rounded">
        ...
        <div class="mt-8 pt-6 border-t border-gray-200">
          ...
          <div class="space-y-2 text-sm">
            <p class="text-gray-700"><span class="font-semibold">Email:</span> ahmed@aiesec.org</p>
            <p class="text-gray-700"><span class="font-semibold">Password:</span> password123</p>
            <p class="text-gray-700"><span class="font-semibold">Email:</span> fatima@aiesec.org</p>
            <p class="text-gray-700"><span class="font-semibold">Password:</span> password123</p>
          </div>
        </div>
        ...
        <div class="mt-6 text-center">
          <p class="text-gray-600 text-sm">
            ...
            <a routerLink="/signup" class="text-blue-600 font-semibold hover:text-blue-700 transition">
              Create one here
            </a>
          </p>
        </div>
