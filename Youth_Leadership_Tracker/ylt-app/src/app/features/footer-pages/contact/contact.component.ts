    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 py-12 px-4 transition-colors duration-300">
      <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 mb-8 transition-colors duration-300">
          <h1 class="text-4xl font-bold text-gray-900 dark:text-white mb-4">📞 {{ 'contact_us' | translate }}</h1>
          <p class="text-xl text-gray-600 dark:text-gray-400">{{ 'get_in_touch' | translate }}</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div class="space-y-6">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 transition-colors duration-300">
              <h2 class="text-2xl font-bold text-blue-600 dark:text-blue-400 mb-6">📍 {{ 'contact_information' | translate }}</h2>
              
              <div class="space-y-6">
                <div class="flex items-start gap-4">
                  <div class="text-3xl">📧</div>
                  <div>
                    <h3 class="font-bold text-gray-900 dark:text-white mb-1">{{ 'email' | translate }}</h3>
                ...
                <div class="flex items-start gap-4">
                  <div class="text-3xl">📱</div>
                  <div>
                    <h3 class="font-bold text-gray-900 dark:text-white mb-1">{{ 'phone' | translate }}</h3>
                ...
                <div class="flex items-start gap-4">
                  <div class="text-3xl">📍</div>
                  <div>
                    <h3 class="font-bold text-gray-900 dark:text-white mb-1">{{ 'office_location' | translate }}</h3>
                ...
                <div class="flex items-start gap-4">
                  <div class="text-3xl">⏰</div>
                  <div>
                    <h3 class="font-bold text-gray-900 dark:text-white mb-1">{{ 'office_hours' | translate }}</h3>
            ...
            <div class="bg-blue-50 dark:bg-blue-900/30 border-l-4 border-blue-500 rounded-lg p-8 transition-colors duration-300">
              <h3 class="text-lg font-bold text-blue-600 dark:text-blue-400 mb-3">🤝 {{ 'follow_us' | translate }}</h3>
          ...
          <!-- Contact Form -->
          <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 transition-colors duration-300">
            <h2 class="text-2xl font-bold text-blue-600 dark:text-blue-400 mb-6">✉️ {{ 'send_us_message' | translate }}</h2>
            
            <form class="space-y-5">
              <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{{ 'name' | translate }}</label>
                <input 
                  type="text" 
              ...
              <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{{ 'subject' | translate }}</label>
                <input 
                  type="text" 
                  class="w-full px-4 py-2 border-2 border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:outline-none focus:border-blue-500 transition"
                  [placeholder]="'message_subject' | translate"
                />
              </div>

              <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">{{ 'message' | translate }}</label>
                <textarea 
                  ...
                  rows="5"
                  [placeholder]="'your_message_here' | translate"
                ></textarea>
              </div>
