    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-12 px-4">
      <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-lg p-8 mb-8">
          ...
          <p class="text-xl text-gray-600">Complete guide to using the Youth Leadership Tracker</p>
        </div>
        ...
        <div class="space-y-6">
          ...
          <div class="bg-white rounded-lg shadow-md p-8">
            <h2 class="text-2xl font-bold text-blue-600 mb-4">🚀 Getting Started</h2>
          ...
          <!-- Members Section -->
          <div class="bg-white rounded-lg shadow-md p-8">
            <h2 class="text-2xl font-bold text-green-600 mb-4">👥 Members Management</h2>
            <div class="space-y-4 text-gray-700">
              ...
              <p><strong>Filter:</strong> Filter members by department (VP, OC, ER, TM, TL, OGX, ICX, EST)</p>
          ...
          <!-- Experiences Section -->
          <div class="bg-white rounded-lg shadow-md p-8">
            <h2 class="text-2xl font-bold text-purple-600 mb-4">🏆 Experiences Tracking</h2>
            <div class="space-y-4 text-gray-700">
          ...
          <!-- Dashboard Section -->
          <div class="bg-white rounded-lg shadow-md p-8">
            <h2 class="text-2xl font-bold text-indigo-600 mb-4">📊 Analytics Dashboard</h2>
            <div class="space-y-4 text-gray-700">
          ...
          <div class="bg-yellow-50 border-l-4 border-yellow-500 rounded-lg p-8">
            <h2 class="text-2xl font-bold text-yellow-600 mb-4">💡 Tips & Best Practices</h2>
