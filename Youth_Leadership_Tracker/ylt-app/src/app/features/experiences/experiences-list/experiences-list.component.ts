    ...
    <div class="min-h-screen bg-gray-50">
      ...
      <div class="bg-white shadow-sm border-b border-gray-200">
        <div class="max-w-7xl mx-auto px-4 py-6">
          <div class="flex justify-between items-center">
            <div>
              <h1 class="text-3xl font-bold text-gray-900">Leadership Experiences</h1>
              <p class="text-gray-600 mt-2">Manage member leadership experiences and roles</p>
            </div>
            <a 
      ...
      <div class="max-w-7xl mx-auto px-4 py-8">
          ...
          @for (experience of paginatedExperiences; track experience.id) {
            <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition p-6 border-l-4 border-blue-500">
              ...
              <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4 py-4 border-y border-gray-200">
                <div>
                  <label class="text-xs font-medium text-gray-600">Member</label>
                  <p class="text-gray-900 font-semibold">{{ getMemberName(experience.memberId) }}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p class="text-gray-900">{{ experience.startDate | date: 'MMM dd, yyyy' }}</p>
                </div>
                <div>
                  <label class="text-xs font-medium text-gray-600">End Date</label>
                  <p class="text-gray-900">{{ experience.endDate ? (experience.endDate | date: 'MMM dd, yyyy') : 'Ongoing' }}</p>
                </div>
              </div>

              <!-- Skills -->
              <div class="mb-4">
                <label class="text-xs font-medium text-gray-600 block mb-2">Skills Gained</label>
        ...
        <div *ngIf="filteredExperiences.length === 0" class="text-center py-12">
          ...
          <h3 class="text-lg font-semibold text-gray-900 mb-2">No experiences found</h3>
