  ...
  template: `
    <div class="min-h-screen bg-gray-50">
      ...
      <div class="bg-white shadow-sm border-b border-gray-200">
        <div class="max-w-4xl mx-auto px-4 py-6">
          <div class="flex items-center gap-3 mb-2">
            <a routerLink="/experiences" class="text-blue-600 hover:text-blue-700 font-semibold">
              ← Back to Experiences
            </a>
          </div>
      ...
      <div class="max-w-4xl mx-auto px-4 py-8">
        ...
        <!-- Form -->
        <form [formGroup]="experienceForm" (ngSubmit)="onSubmit()" class="bg-white rounded-lg shadow-md p-8">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <p *ngIf="isFieldInvalid('memberId')" class="text-red-500 text-sm mt-1">
                Member is required
              </p>
            </div>
            ...
            <div>
              ...
              <input
                ...
                class="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-blue-500 transition"
              />
              <p *ngIf="isFieldInvalid('startDate')" class="text-red-500 text-sm mt-1">
          ...
          <div class="mt-8 pt-8 border-t border-gray-200">
            ...
            <p *ngIf="isFieldInvalid('skillsGained')" class="text-red-500 text-sm mt-2">
